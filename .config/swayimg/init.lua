...
swayimg.text.set_foreground(0xfffafaf9)   -- foreground text color
swayimg.text.set_background(0x800c0909)   -- text background color
swayimg.text.set_shadow(0xff292424)       -- text shadow color
...
swayimg.viewer.set_window_background(0xff292424) -- window background color
swayimg.viewer.set_image_chessboard(10, 0xff292424, 0xff47403e) -- chessboard
